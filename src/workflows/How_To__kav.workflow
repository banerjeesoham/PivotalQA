...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>How_To_Approval_Alert</fullName>
        <description>How To Approval Alert</description>
        ...
        <template>Knowledge_Article_Templates/How_To_Approval_Email</template>
    </alerts>
    <alerts>
        <fullName>How_To_Rejection_Alert</fullName>
        <description>How To Rejection Alert</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        ...
        <senderAddress>support.scqa@pivotal.io</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>Knowledge_Article_Templates/How_To_Rejection_Email</template>
    </alerts>
    <fieldUpdates>

...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <ccEmails>pds-leads@pivotal.io.scqa, PDS-Amer-OfficeLeads@pivotal.io.scqa, projectops@pivotal.io.scqa</ccEmails>
        ...
        <recipients>
            <recipient>jbower@pivotal.io</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        ...
        <ccEmails>pds-leads@pivotal.io.scqa</ccEmails>
    ...
    <alerts>
        ...
        <recipients>
            <recipient>jkachadurian@pivotal.io</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>jwhitford@pivotal.io</recipient>
        ...
        <recipients>
            <recipient>smasud@pivotal.io</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        <fullName>Final_approved_opportunity_for_legal_Email_alert</fullName>
        <description>Final approved opportunity for legal Email alert</description>
        <protected>false</protected>
        <recipients>
            <recipient>ezuniga@pivotal.io</recipient>
            <type>user</type>
        ...
        <template>Opportunity_Approval/VF_Legal</template>
    </alerts>
    <alerts>
        <fullName>IoT_terms_mentioned</fullName>
        <ccEmails>tpt-pm@pivotal.io.scqa</ccEmails>
    ...
    <alerts>
        ...
        <ccEmails>rmartin@pivotal.io.scqa</ccEmails>
        ...
        <recipients>
            <recipient>jwatters@pivotal.io</recipient>
            <type>user</type>
        </recipients>
        <senderAddress>sfautomation@pivotal.io</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
    ...
    <alerts>
        ...
        <ccEmails>serviceops@pivotal.io.scqa</ccEmails>
    ...
    <fieldUpdates>
        <fullName>Set_Forecast_Status_to_Pipeline</fullName>
        <field>Forecast_Status__c</field>
        <literalValue>Pipeline</literalValue>
        <name>Set Forecast Status to Pipeline</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Set_Opp_State_to_Prospecting</fullName>
        <field>StageName</field>
        <literalValue>Prospecting</literalValue>
        <name>Set Opp Stage to Prospecting</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_the_approval_status_to_In_progress</fullName>
        <field>Approval_Status_picklist__c</field>
        <literalValue>In Progress</literalValue>
        <name>Set the approval status to In progress</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_the_approval_status_to_no_value</fullName>
        <field>Approval_Status_picklist__c</field>
        <name>Set the approval status to no value</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <rules>
        ...
        <formula>ISPICKVAL(StageName,&quot;Booked&quot;) &amp;&amp;   (Total_Pivotal_Labs__c &gt; 0 ||  Total_Data_Services__c &gt;0 ||  Total_Edu__c &gt; 0 ||  Total_PaaS_Services__c &gt; 0 ||  Total_Transformation__c &gt; 0 ||  Total_Agile_DS__c &gt; 0 ||  Total_CSD__c &gt; 0 || CONTAINS(Product_Concat__c, &apos;Custom&apos;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>

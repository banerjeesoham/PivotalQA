...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <ccEmails>sfdc-internal@pivotal.io.scqa</ccEmails>
    ...
    <rules>
        ...
        <formula>OR(isNew(), isChanged(Name), isChanged(BillingStreet), isChanged(BillingState), isChanged(BillingCountry)) &amp;&amp;   (RPS_Status__c == &apos;Pending&apos;)</formula>

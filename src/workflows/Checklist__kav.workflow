...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Checklist_Article_has_been_approved</fullName>
        <description>Checklist Article has been approved</description>
        ...
        <template>Knowledge_Article_Templates/Checklist_Approval_Email</template>
    </alerts>
    <alerts>
        <fullName>Checklist_article_has_been_rejected</fullName>
        <description>Checklist article has been rejected</description>
        <protected>false</protected>
        <recipients>
            <type>creator</type>
        </recipients>
        ...
        <senderAddress>support.scqa@pivotal.io</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>Knowledge_Article_Templates/Checklist_Rejection_Email</template>
    </alerts>
    <fieldUpdates>
